...
* Return : None.
*******************************************************************************/
// - This CMD17/18 based code should be slightly faster, maybe needs better error handling?
	...
	if (TransferState == TXFR_ONGOING ){
		...
		if(Mass_Block_Size[lun]==Block_offset) { //If we have finished the DMA transfer
			...
			if(Length>BULK_MAX_PACKET_SIZE) //Data remains
				rcvr_datablock((volatile BYTE *)Data_Buffer, 512);//Receive a new datablock - aquires card and starts DMA
